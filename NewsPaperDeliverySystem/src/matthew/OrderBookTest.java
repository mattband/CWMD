...
public class OrderBookTest extends TestCase {
	...
	public void testValidateOrderID002() {
		try {
			...
			assertEquals("The Order ID is not a valid integer. Please enter a correct 5-digit Order ID.",
					e.getMessage());
		}
	}
	...
	public void testValidateCustomerID002() {
		try {
			...
			assertEquals("The customer ID is not a valid integer. Please enter a correct 5-digit customer ID.",
					e.getMessage());
		}
	}
